...
var LogonGrammar = []cli.Option{
	{
		...
		EnvironmentVariable: "APP_USERNAME",
	},
	{
		LongName:            "password",
		ShortName:           "p",
		...
		EnvironmentVariable: "APP_PASSWORD",
	},
	{
		...
		EnvironmentVariable: "APP_LOGON_SERVER",
	},
}
...
func resolveServerName(name string) (string, error) {
	...
	if hasScheme {
		settings.SetDefault("app.application.server", name)
	...
	settings.SetDefault("app.application.server", normalizedName)
