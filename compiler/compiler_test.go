	...
	tests := []struct {
	...
	}{
		{
			...
			want: []bytecode.I{
				...
				{Opcode: bytecode.BranchFalse, Operand: 29},
				{Opcode: bytecode.AtLine, Operand: 1},
				{Opcode: bytecode.AtLine, Operand: 1},
				{Opcode: bytecode.Load, Operand: "i"},
				{Opcode: bytecode.Push, Operand: "="},
				...
				{Opcode: bytecode.BranchFalse, Operand: 20},
				{Opcode: bytecode.AtLine, Operand: 1},
				{Opcode: bytecode.AtLine, Operand: 1},
				{Opcode: bytecode.Branch, Operand: 29},
				{Opcode: bytecode.AtLine, Operand: 1},
				{Opcode: bytecode.Load, Operand: "i"},
				...
				{Opcode: bytecode.Store, Operand: "i"},
				{Opcode: bytecode.Branch, Operand: 3},
			},
		},
		{
			name: "Simple block",
