...
const (
	...
	// Struct kind. A struct has an _APP_ implementation
	// that includes the fields and their values as well as
	// additional typing metata.
	StructKind

	// Error kind. This holds an _APP_ error value (errors.Error).
	ErrorKind

	// Channel kind. This holds an _APP_ channel, which is a Go
	// channel with additioanl state information.
	ChanKind

	// Map kind. An _APP_ map functions like a standard Go map
	...
	// Array kind. An _APP_ array is an array of interface values, along
